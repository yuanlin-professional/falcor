# SampleGeneratorTests 源码文档

> 路径: `Source/Tools/FalcorTest/Tests/Sampling/SampleGeneratorTests.cpp`
> 类型: C++ 实现
...
| 测试名称 | 说明 |
|----------|------|
| `SampleGenerator_TinyUniform` | GPU 测试用例 |
| `SampleGenerator_Uniform` | GPU 测试用例 |
...
- [`SampleGeneratorTests.cs.slang`](SampleGeneratorTests.cs.slang.md)
