# SlangInheritance 源码文档

> 路径: `Source/Tools/FalcorTest/Tests/Slang/SlangInheritance.cpp`
> 类型: C++ 实现
...
| 测试名称 | 说明 |
|----------|------|
| `SlangStructInheritanceLayout` | GPU 测试用例 |
...
- [`SlangInheritance.cs.slang`](SlangInheritance.cs.slang.md)
