...
> 路径: `Source/Tools/FalcorTest/Tests/Slang/TraceRayFlags.cpp`
> 类型: C++ 实现
...
| 测试名称 | 说明 |
|----------|------|
| `TraceRayFlagsDXR1_0` | GPU 测试用例 |
| `TraceRayFlagsDXR1_1` | GPU 测试用例 |
...
- [`TraceRayFlags.cs.slang`](TraceRayFlags.cs.slang.md)
