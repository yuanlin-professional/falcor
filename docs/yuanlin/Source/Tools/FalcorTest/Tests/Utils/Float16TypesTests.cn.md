# Float16TypesTests 源码文档

> 路径: `Source/Tools/FalcorTest/Tests/Utils/Float16TypesTests.cpp`
> 类型: C++ 实现
> 模块: Tools/FalcorTest/Tests/Utils

## 功能概述

测试 CPU 端 16 位浮点类型的创建、转换和算术操作。
...
| 测试名称 | 说明 |
|----------|------|
| `Float16Vector` | CPU 测试用例 |
| `Float16Scalar` | CPU 测试用例 |
