...
> 路径: `Source/Tools/FalcorTest/Tests/Utils/HalfUtilsTests.cpp`
> 类型: C++ 实现
...
| 测试名称 | 说明 |
|----------|------|
| `FP16ToFP32Conversion` | GPU 测试用例 |

### CPU 测试

| 测试名称 | 说明 |
|----------|------|
| `FP32ToFP16ConservativeRoundingCPU` | CPU 测试用例 |
...
- [`HalfUtilsTests.cs.slang`](HalfUtilsTests.cs.slang.md)
